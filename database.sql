...
(1, 'Hafriyat & Saha Kantar Otomasyonu', 'hafriyat-saha-kantar-otomasyonu', 'Hafriyat sahaları ve döküm alanları için otonom kantar ve irsaliye yazılımı.', 'Hafriyat yönetim sistemleri, saha kantarları ve geçiş kontrol noktaları için indikatör haberleşmeli, otomatik bariyerli ve canlı ön muhasebe entegrasyonlu uçtan uca kantar otomasyonu sunuyoruz. Saha trafiğinizi ve tartım süreçlerinizi anlık raporluyoruz.', 'fa-truck-ramp-box', 1),
(2, 'Yapay Zeka & Akıllı Otomasyon', 'yapay-zeka-akilli-otomasyon', 'Saha operasyonlarınızı ve kantar verilerinizi otonom hale getiren yapay zeka çözümleri.', 'Kurumunuza özel eğitilmiş LLM modelleri, doğal dil işleme asistanları ve Ar-Ge aşamasındaki görüntülü saha/araç tanıma AI algoritmaları geliştiriyoruz. Veri işleme maliyetlerinizi düşürürken operasyonel verimliliğinizi katlıyoruz.', 'fa-brain', 2),
...
(1, 'Kantar & Saha Kamera AI Plaka Tanıma', 'Ar-Ge / Geliştirilmekte', 'Saha kantarlarında geçen araç plakalarını ve dorseleri kameralar üzerinden otonom tanıyacak görüntü işleme ve yapay zeka modelimiz Ar-Ge aşamasındadır.', '["Ar-Ge Aşamasında Özel Model", "Gece / Gündüz Plaka Okuma Algoritması", "Otomatik Bariyer ve Kantar Tetikleme", "Anlık Veritabanı ve Ön Muhasebe Kaydı"]', 'fa-eye', 1),
...
(1, 'Hafriyat & Saha Kantar Otomasyonu', 'Bursa Bölge Hafriyat Sahaları', 'Kantar Otomasyonu', 'C#, .NET, MySQL, İndikatör & Bariyer', 'Endüstriyel kantar indikatörleri ile haberleşen, otomatik bariyer tetiklemeli ve hafriyat döküm takip yazılımı projesi.', 'assets/images/project1.jpg', '#', 1),
